...
object DefaultApi {
  ...
  def demandsGet(): ApiRequest[Seq[Demand]] =
    ApiRequest[Seq[Demand]](ApiMethods.GET, "https://virtserver.swaggerhub.com/argonautscrew/ongbook/2.0.0", "/demands", "application/json")
  ...
  def ngosGet(): ApiRequest[Seq[NGO]] =
    ApiRequest[Seq[NGO]](ApiMethods.GET, "https://virtserver.swaggerhub.com/argonautscrew/ongbook/2.0.0", "/ngos", "application/json")
